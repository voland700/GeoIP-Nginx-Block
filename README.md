...
Для блокировки доступа используются данные базы данных GeoLite, (ресурс в настоящее время является платным и требует регистрации, кроме того, пользователям некоторых стран, в том числе РФ, доступ запрешен).
...
В данном GIT репозитории ссылки на базы данных geo ip по ASN - провайдеров, городам и странам. Для блокировки доступа к сайту по странам, используем ссылку на базу:  GeoLite2-Country.mmdb - из указанного репозитория.
